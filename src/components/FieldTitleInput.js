...
const FieldTitleInput = ({handleMinusIconClick,id,cursor,checkListItem,setCheckListItem2,setCheckListItem1,checkListItemIsClick,setCheckListItemIsClick}) => {
...
<div className='field-title-inp'>
    ...
    <div onClick={()=>handleMinusIconClick(id)} style={{cursor:cursor}} className='minus-icon ms-auto'><MinusIcon /></div>
</div>
   </>
  )
}
